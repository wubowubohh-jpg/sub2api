...
func (s *AccountTestService) TestAccountConnectionWithAccount(c *gin.Context, account *Account, modelID string, prompt string, mode string) error {
	return s.testAccountConnectionWithAccount(c, account, modelID, prompt, mode, AccountTestOptions{})
}

func (s *AccountTestService) testAccountConnectionWithAccount(c *gin.Context, account *Account, modelID string, prompt string, mode string, testOpts AccountTestOptions) error {
	if account == nil {
		return s.sendErrorAndEnd(c, "Account not found")
	}
	if account.IsTransientTest() && s.accountRepo != nil {
		return s.TestTransientAccountConnection(c, account, modelID, prompt, mode, testOpts)
	}
...
func (s *AccountTestService) TestTransientAccountConnection(c *gin.Context, account *Account, modelID string, prompt string, mode string, opts ...AccountTestOptions) error {
	if s == nil {
	...
	probe := &AccountTestService{
		...
		grokWSDialer:              s.grokWSDialer,
	}
	return probe.testAccountConnectionWithAccount(c, account, modelID, prompt, mode, firstAccountTestOptions(opts))
}
